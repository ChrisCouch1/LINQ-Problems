...
namespace PracticeProblemsLINQ
{
    public static class LinqProblems
    {
        ...
        public static List<string> RunProblem1(List<string> words)
        {
            ...
            List<string> thWords = words.Where(word => word.Contains("th")).ToList();
        ...
        public static Customer RunProblem3(List<Customer> customers)
        {
            ...
            var justMike = customers.First(c => c.FirstName == "Mike");
        ...
        {
            //code
            var newName = customers.First(c => c.Id == 3);
                newName.FirstName = "Donald";
                newName.LastName = "McRonald";
        ...
        {
            //code
            foreach (string setOfGrades in classGrades)
            {
                classGrades.Remove(classGrades.Min());
            }
            var avg = classGrades.Select(double.Parse).Average();
